...
AGENT_MODELS: dict[str, str] = {
    "agent1_analyzer":      "gemini-2.0-flash-001",
    "agent2_strategist":    "gemini-2.0-flash-001",
    "agent3_script_writer": "gemini-1.5-pro-002",
    "agent4_optimizer":     "gemini-2.0-flash-001",
}
